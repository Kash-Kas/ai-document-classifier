...
- [pdf-automation](https://github.com/Kash-Kas/pdf-automation) — Python tool for PDF keyword search, highlight, and file processing
- [job-market-analysis](https://github.com/Kash-Kas/job-market-analysis) — LinkedIn job market analysis using Python, SQL, and Claude API
